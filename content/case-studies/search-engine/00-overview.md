...
- **Crawl rate:** to fully refresh 10B pages on, say, a 30-day cycle: 10B / (30 x 86,400) ≈ **~3,900 pages/sec** sustained crawl throughput (cross-ref [Web Crawler](../web-crawler/00-overview.md) for the politeness/dedup mechanics that actually deliver this rate).
